...
from code_assist.config.claude_md import build_claude_md_context, get_memory_files
from code_assist.config.managed_env import get_api_key
...
from code_assist.services.api.claude import SystemPrompt, SystemPromptBlock
from code_assist.tools.base import ToolDef, ToolUseContext, Tools
from code_assist.tools.registry import filter_enabled_tools
from code_assist.types.message import Message, create_user_message
from code_assist.utils.model.model import resolve_model
...
class QueryEngine:
    ...
    async def submit_message(
        ...
        if processed.is_command:
            ...
            from code_assist.core.query import TextEvent
