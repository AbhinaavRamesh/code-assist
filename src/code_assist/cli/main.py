...
@click.command()
@click.version_option(version=__version__, prog_name="code-assist")
...
def cli(
    ...
    """Code Assist - AI-powered coding assistant."""
    from code_assist.utils.log import setup_logging
...
async def _run_single_query(
    ...
    *,
    ...
    from code_assist.core.query import TextEvent, ToolUseEvent, DoneEvent
    from code_assist.core.query_engine import QueryEngine, QueryEngineConfig
...
def _run_interactive(
    *,
    ...
    console = Console()
    console.print(f"[bold]Code Assist v{__version__}[/bold]")
