...
from claude_code.types.command import CommandBase
from claude_code.types.ids import AgentId
...
from claude_code.types.plugin import LoadedPlugin
from claude_code.types.tools import SpinnerMode
